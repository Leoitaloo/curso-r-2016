...
img_df_parte12$new.col <- predict_lm2 #È preciso criar um novo "cor"
img_df_parte12$new.cor <- rgb(img_df_parte12$r, img_df_parte12$g, abs(img_df_parte12$new.col)) #transformando os n˙meros em positivos
...
img_df_parte12$new.col <- predict_tree2 #È preciso criar um novo "cor"
img_df_parte12$new.cor <- rgb(img_df_parte12$r, img_df_parte12$g, abs(img_df_parte12$new.col)) #transformando os n˙meros em positivos
...
img_df_parte12 <- img_df_parte12 %>% 
  mutate(erro_lm2 = (b - predict_lm2)^2, erro_tree2 = (b - predict_tree2)^2)


erro_total_lm <- sum(img_df_parte12$erro_lm2)
erro_total_lm

erro_total_tree <- sum(img_df_parte12$erro_arv2)
erro_total_tree
